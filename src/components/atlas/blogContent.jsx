...
<p>O exame médico de imigração não é um check-up comum. Ele envolve:</p>
<ul>
<li>Exames laboratoriais especializados e de alta precisão</li>
<li>Avaliação por um médico com certificação especial do USCIS</li>
<li>Documentação rigorosa que será analisada pelo governo americano</li>
<li>Responsabilidade legal do Civil Surgeon</li>
</ul>

<h3>Exames Laboratoriais de Ponta</h3>
<p>Os testes exigidos pelo USCIS são específicos e realizados em laboratórios credenciados:</p>
<ul>
<li>QuantiFERON-TB Gold: Tecnologia avançada para detecção de tuberculose</li>
<li>Testes para DSTs: Rastreamento de sífilis e gonorrhea conforme exigências federais</li>
</ul>

<h3>Conveniência de Uma Só Visita</h3>
<p>Na Atlas Healthcare, a maioria dos pacientes completa todo o processo em uma única visita. Isso significa:</p>
<ul>
<li>Economia de tempo</li>
<li>Menos deslocamentos</li>
<li>Resultados mais rápidos</li>
<li>Processo de imigração acelerado</li>
</ul>

<h2>O seguro saúde cobre o exame?</h2>
<p>É importante esclarecer que o seguro saúde <strong>NÃO</strong> cobre o custo do exame médico de imigração. Isso ocorre porque:</p>
<ul>
<li>O exame é considerado um requisito de imigração, não um cuidado médico necessário</li>
<li>É uma exigência do USCIS, não uma recomendação médica</li>
<li>O processo envolve documentação específica para fins de imigração</li>
</ul>

<h3>Porém, boas notícias!</h3>
<p>Seu seguro saúde pode cobrir as vacinas necessárias. Recomendamos:</p>
<ul>
<li>Verificar com sua seguradora quais vacinas estão cobertas</li>
<li>Trazer seu cartão de seguro para o agendamento</li>
<li>Nossa equipe pode ajudar a verificar a cobertura</li>
</ul>

<h2>Comparativo de Custos: Por que não economizar no exame?</h2>
<p>Algumas pessoas consideram buscar opções mais baratas, mas é fundamental entender os riscos:</p>

<h3>❌ Riscos de opções não autorizadas:</h3>
<ul>
<li>Formulário I-693 pode ser rejeitado pelo USCIS</li>
<li>Necessidade de refazer todo o processo</li>
<li>Perda de tempo e dinheiro</li>
<li>Atraso no processo de imigração</li>
<li>Possíveis complicações legais</li>
</ul>

<h3>✅ Benefícios de um Civil Surgeon autorizado:</h3>
<ul>
<li>100% de aceitação pelo USCIS</li>
<li>Documentação correta e completa</li>
<li>Processo ágil e sem complicações</li>
<li>Suporte contínuo</li>
<li>Garantia de qualidade</li>
</ul>

<h2>Formas de Pagamento</h2>
<p>Na Atlas Healthcare, aceitamos:</p>
<ul>
<li>Dinheiro</li>
<li>Cartões de crédito e débito</li>
<li>Transferência bancária</li>
</ul>
<p>Não aceitamos cheques para este serviço.</p>

<h2>Dicas para planejar seu orçamento</h2>
<ul>
<li>Considere o exame como um investimento no seu futuro nos EUA</li>
<li>Planeje com antecedência - não deixe para última hora</li>
<li>Verifique a cobertura de vacinas do seu seguro</li>
...
<h3>1. Passaporte ou Documento de Identidade Válido</h3>
<ul>
<li>Deve ser um documento oficial com foto</li>
<li>Pode ser passaporte do seu país de origem</li>
<li>Documento de identidade estadual ou carteira de motorista americana também são aceitos</li>
<li>Certifique-se de que não está vencido</li>
</ul>

<h3>2. Cartão de Vacinação (Se Disponível)</h3>
<ul>
<li>Traga seu cartão de vacinação original</li>
<li>Se estiver em outro idioma, não se preocupe - nossa equipe pode ajudar</li>
<li>Se não tiver, não é um problema - o Dr. Wingo determinará quais vacinas você precisa</li>
<li>Vacinas anteriores podem evitar revacinação desnecessária</li>
</ul>

<h3>3. Lista de Medicamentos Diários</h3>
<p>Prepare uma lista completa incluindo:</p>
<ul>
<li>Nome de cada medicamento</li>
<li>Dosagem</li>
<li>Frequência de uso</li>
<li>Motivo da prescrição</li>
<li>Nome do médico que prescreveu</li>
</ul>
<p><strong>Dica:</strong> Traga os frascos dos medicamentos ou uma receita médica atualizada.</p>

<h2>Documentos Adicionais (Quando Aplicável)</h2>

<h3>4. Autorização de Trabalho (EAD)</h3>
<p>Se você possui EAD, traga:</p>
<ul>
<li>O documento original</li>
<li>Uma cópia (se possível)</li>
<li>Isso ajuda a verificar seu status atual</li>
</ul>

<h3>5. Cartão de Seguro Saúde</h3>
<p>Embora o seguro não cubra o exame de imigração:</p>
<ul>
<li>Pode cobrir vacinas necessárias</li>
<li>Ajuda a verificar seu histórico médico</li>
<li>Nossa equipe pode verificar coberturas disponíveis</li>
</ul>

<h3>6. Exame I-693 Anterior (Se Tiver)</h3>
<p>Se você já fez um exame médico de imigração anteriormente:</p>
<ul>
<li>Traga o formulário anterior</li>
<li>Isso pode ajudar a identificar quais vacinas você já tem</li>
<li>Pode acelerar o processo</li>
</ul>

<h2>Preparação para o Dia do Exame</h2>

<h3>O que vestir?</h3>
<ul>
<li>Roupas confortáveis e fáceis de remover, se necessário</li>
<li>Evite roupas muito apertadas</li>
<li>Sapatos confortáveis (pode ser necessário ficar em pé para alguns exames)</li>
<li>Evite joias excessivas</li>
</ul>

<h3>Alimentação e Hidratação</h3>
<ul>
<li>Não é necessário jejum para a maioria dos exames</li>
<li>Hidrate-se bem - isso facilita a coleta de sangue</li>
<li>Evite álcool 24 horas antes do exame</li>
<li>Café da manhã leve é recomendado</li>
</ul>

<h3>Outras Considerações</h3>
<ul>
<li>Chegue 15 minutos antes do horário agendado</li>
<li>Evite exercícios intensos no dia do exame</li>
<li>Durma bem na noite anterior</li>
<li>Mantenha-se calmo - o processo é simples e rápido</li>
</ul>

<h2>Casos Especiais</h2>

<h3>Se você estiver grávida</h3>
<ul>
<li>Informe-nos com antecedência ao agendar</li>
<li>Certas vacinas podem ser adiadas por segurança</li>
<li>O exame físico será adaptado para sua condição</li>
<li>Traga seus exames pré-natais recentes, se disponíveis</li>
</ul>

<h3>Se você estiver amamentando</h3>
<ul>
<li>Informe o médico durante o exame</li>
<li>A maioria das vacinas é segura durante a amamentação</li>
<li>O médico orientará sobre quaisquer precauções necessárias</li>
</ul>

<h3>Crianças e adolescentes</h3>
<ul>
<li>Menores de 18 anos devem estar acompanhados de um responsável legal</li>
<li>Traga documento do responsável</li>
<li>Histórico de vacinação infantil é essencial</li>
...
<p><strong>Dica final:</strong> Tire uma foto de todos os seus documentos importantes e guarde no celular como backup, caso algo seja esquecido.</p>
    ...
    4: {
      content: `
<h2>Introdução</h2>
<p>A vacinação é um dos componentes mais importantes do exame médico de imigração. O USCIS exige que imigrantes estejam protegidos contra certas doenças para proteger a saúde pública. Neste artigo, vamos explorar em detalhes quais vacinas são obrigatórias, como verificar se você já está protegido e o que fazer se não tiver comprovação.</p>

<h2>Por que as Vacinas São Importantes?</h2>
<p>O governo americano exige vacinação por vários motivos:</p>
<ul>
<li><strong>Proteção da saúde pública:</strong> Prevenir surtos de doenças contagiosas</li>
<li><strong>Saúde individual:</strong> Proteger você e sua família</li>
<li><strong>Cumprimento legal:</strong> Requisito obrigatório para residência permanente</li>
<li><strong>Prevenção de complicações:</strong> Evitar doenças que podem ser graves</li>
</ul>

<h2>Lista de Vacinas Obrigatórias para Imigração</h2>

<h3>Vacinas para Adultos (15 anos ou mais)</h3>

<h4>1. Hepatite A e B</h4>
<ul>
<li>Hepatite A: Transmitida por alimentos e água contaminados</li>
<li>Hepatite B: Transmitida por sangue e fluidos corporais</li>
<li>Esquema: Hepatite B geralmente requer 3 doses</li>
<li>Importância: Proteção contra doenças hepáticas graves</li>
</ul>

<h4>2. Influenza (Gripe)</h4>
<ul>
<li>Atualização anual necessária</li>
<li>Importante durante a temporada de gripe (geralmente outubro a março)</li>
<li>Protege contra complicações graves</li>
</ul>

<h4>3. Varicela (Catapora)</h4>
<ul>
<li>Obrigatória se você nunca teve catapora</li>
<li>Dois tipos de comprovação aceitos:
  <ul>
    <li>Histórico médico documentado de catapora</li>
    <li>Duas doses da vacina</li>
  </ul>
</li>
<li>Importante: Adultos não vacinados têm maior risco de complicações</li>
</ul>

<h4>4. MMR (Sarampo, Caxumba e Rubéola)</h4>
<ul>
<li>Uma das vacinas mais importantes</li>
<li>Duas doses necessárias (ou comprovação de imunidade)</li>
<li>Sarampo: Doença altamente contagiosa e potencialmente grave</li>
<li>Rubéola: Especialmente perigosa para mulheres grávidas</li>
</ul>

<h4>5. Tdap (Tétano, Difteria e Coqueluche)</h4>
<ul>
<li>Reforço a cada 10 anos</li>
<li>Tétano: Bactéria encontrada no solo</li>
<li>Coqueluche: Doença respiratória grave, especialmente para bebês</li>
<li>Importante: Mesmo que tenha tomado DTP na infância, o reforço é necessário</li>
</ul>

<h4>6. Pneumocócica</h4>
<ul>
<li>Recomendada para adultos com condições de risco</li>
<li>Protege contra pneumonia, meningite e septicemia</li>
<li>Pode ser necessária dependendo da idade e condições de saúde</li>
</ul>

<h3>Vacinas Adicionais para Crianças</h3>

<h4>1. Rotavírus</h4>
<ul>
<li>Para crianças menores de 8 meses</li>
<li>Protege contra diarreia grave</li>
<li>Duas ou três doses, dependendo da vacina</li>
</ul>

<h4>2. Haemophilus influenzae tipo b (Hib)</h4>
<ul>
<li>Protege contra meningite e outras infecções graves</li>
<li>Série de doses na infância</li>
</ul>

<h4>3. Poliomielite (Pólio)</h4>
<ul>
<li>Série de 4 doses na infância</li>
<li>Reforço pode ser necessário em alguns casos</li>
</ul>

<h2>Como Comprovar suas Vacinas</h2>

<h3>1. Cartão de Vacinação Oficial</h3>
<ul>
<li>Documento do seu país de origem</li>
<li>Registros de vacinação de clínicas particulares</li>
<li>Histórico de vacinação do exército (se aplicável)</li>
</ul>

<h3>2. Exames de Titulação (Blood Titer Tests)</h3>
<p>Se você não tiver comprovação de vacinação:</p>
<ul>
<li>Exames de sangue que medem anticorpos</li>
<li>Comprovam imunidade contra doenças específicas</li>
<li>Podem substituir a revacinação</li>
<li>Disponíveis na Atlas Healthcare</li>
</ul>

<h3>3. Histórico Médico Documentado</h3>
<ul>
<li>Atestado médico de doenças como catapora</li>
<li>Registros de hospital</li>
<li>Deve ser documentação oficial</li>
</ul>

<h2>E se eu não tiver comprovação de vacinação?</h2>
<p>Não se preocupe! Esta é uma situação muito comum. O Dr. Wingo irá:</p>
<ul>
<li>Avaliar sua situação individual</li>
<li>Determinar quais vacinas são necessárias</li>
<li>Oferecer exames de titulação quando apropriado</li>
<li>Administrar vacinas disponíveis no local</li>
<li>Orientar sobre vacinas adicionais que possam ser necessárias</li>
</ul>

<h2>Vacinas Disponíveis no Local</h2>
<p>Na Atlas Healthcare, oferecemos a maioria das vacinas necessárias:</p>
<ul>
<li>✅ Influenza (gripe)</li>
<li>✅ Tdap</li>
<li>✅ MMR</li>
...
<li>✅ Hepatite A e B</li>
<li>✅ Pneumocócica</li>
<li>✅ Outras conforme necessidade</li>
</ul>
...
<h3>Grávidas</h3>
<ul>
<li>Certas vacinas são adiadas por segurança</li>
<li>Tdap é recomendada durante cada gravidez</li>
<li>Influenza é segura e recomendada</li>
<li>Outras vacinas são programadas para após o parto</li>
</ul>

<h3>Amamentação</h3>
<ul>
<li>A maioria das vacinas é segura</li>
<li>Não afeta o leite materno</li>
<li>Protege a mãe e indiretamente o bebê</li>
</ul>

<h2>Efeitos Colaterais das Vacinas</h2>
<p>As vacinas são seguras, mas podem causar efeitos colaterais leves:</p>
<ul>
<li>Dor no local da injeção</li>
<li>Vermelhidão ou inchaço</li>
<li>Febre baixa</li>
<li>Cansaço leve</li>
</ul>
<p>Estes sintomas normalmente desaparecem em 1-2 dias.</p>

<h2>Conclusão</h2>
<p>A vacinação é um passo essencial e benéfico no processo de imigração. Além de ser um requisito legal, você estará protegendo sua saúde e a de sua família. Na Atlas Healthcare, tornamos este processo simples e sem complicações.</p>
<p><strong>Lembre-se:</strong> Mesmo que não tenha comprovação de vacinação, podemos ajudar a determinar exatamente o que você precisa e administrar as vacinas necessárias no mesmo dia do exame.</p>
      `,
    },
    5: {
      content: `
<h2>Introdução</h2>
<p>A gravidez é um momento especial que requer cuidados adicionais em todas as áreas da saúde, incluindo o exame médico de imigração. Muitas mulheres grávidas têm dúvidas sobre a segurança do processo e como ele pode afetar sua gestação. Neste artigo, vamos esclarecer todas as questões relacionadas ao exame médico de imigração durante a gravidez.</p>

<h2>Posso fazer o exame médico de imigração estando grávida?</h2>
<p><strong>Sim!</strong> É perfeitamente seguro realizar o exame médico de imigração durante a gravidez. Na verdade, muitas mulheres completam este processo enquanto estão grávidas. O importante é informar o Civil Surgeon sobre sua condição para que adaptações necessárias sejam feitas.</p>

<h2>Adaptações para Gestantes</h2>

<h3>1. Exame Físico Modificado</h3>
<p>O exame físico será realizado de forma a garantir seu conforto e segurança:</p>
<ul>
<li>Posições confortáveis para a gestante</li>
<li>Evitação de pressão abdominal excessiva</li>
<li>Monitoramento da pressão arterial (importante na gravidez)</li>
<li>Avaliação adaptada ao estágio da gestação</li>
</ul>

<h3>2. Vacinas e Gravidez</h3>
<p>Esta é a área que requer mais atenção:</p>

<h4>✅ Vacinas Seguras Durante a Gravidez:</h4>
<ul>
<li><strong>Influenza (gripe):</strong> Recomendada para todas as gestantes</li>
<li><strong>Tdap (tétano, difteria, coqueluche):</strong> Recomendada entre 27 e 36 semanas</li>
</ul>

<h4>⚠️ Vacinas Adiadas:</h4>
<ul>
<li><strong>MMR (sarampo, caxumba, rubéola):</strong> Adiada para após o parto</li>
<li><strong>Varicela:</strong> Adiada para após o parto</li>
<li><strong>Hepatite A:</strong> Geralmente adiada</li>
</ul>

<h4>✅ Vacinas que Podem Ser Administradas:</h4>
<ul>
<li><strong>Hepatite B:</strong> Segura quando necessária</li>
<li><strong>Outras vacinas:</strong> Avaliadas caso a caso</li>
</ul>

<h3>3. Exames Laboratoriais</h3>
<p>A maioria dos exames laboratoriais é segura:</p>
<ul>
<li><strong>QuantiFERON-TB Gold:</strong> Seguro durante a gravidez</li>
<li><strong>Sífilis RPR:</strong> Importante para saúde da mãe e bebê</li>
<li><strong>Gonorrhea:</strong> Seguro e necessário</li>
</ul>

<h2>Quando Informar sobre a Gravidez?</h2>

<h3>Ao Agendar</h3>
<p>Recomendamos fortemente que informe sobre sua gravidez no momento do agendamento. Isso permite que:</p>
<ul>
<li>Reservemos tempo adicional se necessário</li>
<li>Preparemos adaptações específicas</li>
<li>Programemos vacinas adequadas à sua situação</li>
<li>Tenhamos informações sobre seu estágio gestacional</li>
</ul>

<h3>No Dia do Exame</h3>
<p>Mesmo que tenha informado ao agendar, confirme novamente no dia do exame:</p>
<ul>
<li>Quantas semanas de gestação você tem</li>
<li>Se há alguma complicação</li>
<li>Se está sob cuidado de um obstetra</li>
</ul>

<h2>Documentos Adicionais para Gestantes</h2>
<p>Além dos documentos padrão, traga:</p>
<ul>
<li>Exames pré-natais recentes</li>
<li>Nome e contato do seu obstetra</li>
<li>Histórico de gravidez anterior (se aplicável)</li>
<li>Lista de vitaminas e suplementos que está tomando</li>
<li>Comprovação de vacina Tdap anterior (se tiver)</li>
</ul>

<h2>Benefícios de Fazer o Exame Durante a Gravidez</h2>

<h3>1. Conveniência</h3>
<ul>
<li>Resolve uma etapa importante antes do nascimento do bebê</li>
<li>Evita preocupações durante os primeiros meses com o novo bebê</li>
<li>Permite foco no processo de imigração sem interrupções</li>
</ul>

<h3>2. Vacinação Tdap</h3>
<p>A vacina Tdap é especialmente importante na gravidez porque:</p>
<ul>
<li>Protege você contra coqueluche</li>
<li>Passa anticorpos para o bebê, protegendo-o nos primeiros meses</li>
<li>Recomendada pelo CDC em cada gravidez</li>
</ul>

<h3>3. Detecção Precoce</h3>
<p>O exame pode identificar:</p>
<ul>
<li>Infecções que precisam de tratamento</li>
<li>Condições de saúde que precisam de acompanhamento</li>
<li>Necessidades de saúde específicas da gravidez</li>
</ul>

<h2>Segurança do Bebê</h2>

<h3>O exame prejudica o bebê?</h3>
<p><strong>Não.</strong> O exame médico de imigração não representa risco para o bebê:</p>
<ul>
<li>Exame físico é adaptado para gestantes</li>
<li>Exames laboratoriais são seguros</li>
<li>Vacinas seguras são administradas</li>
<li>Vacinas não seguras são adiadas</li>
</ul>

<h3>Radiografias</h3>
<p>Não há necessidade de raio-X no exame médico de imigração padrão. Se algum exame de imagem for necessário por razões médicas específicas, o médico discutirá os riscos e benefícios com você.</p>

<h2>Planejamento do Timing</h2>

<h3>Melhor Momento para o Exame</h3>

<h4>Primeiro Trimestre (1-12 semanas)</h4>
<ul>
<li>✅ Você pode estar se sentindo bem</li>
<li>⚠️ Algumas vacinas serão adiadas</li>
<li>⚠️ Pode haver náuseas que dificultam a visita</li>
</ul>

<h4>Segundo Trimestre (13-27 semanas)</h4>
<ul>
<li>✅ Geralmente o período mais confortável</li>
<li>✅ Náuseas geralmente melhoraram</li>
<li>✅ Ótimo momento para Tdap</li>
</ul>

<h4>Terceiro Trimestre (28-40 semanas)</h4>
<ul>
<li>✅ Tdap pode ser administrada (27-36 semanas)</li>
<li>⚠️ Pode ser mais desconfortável devido ao tamanho da barriga</li>
<li>⚠️ Movimentação pode ser mais difícil</li>
</ul>

<h2>Depois do Exame</h2>

<h3>Vacinas Pendentes</h3>
<p>Se algumas vacinas foram adiadas:</p>
<ul>
<li>Agende para após o parto</li>
<li>Pode ser feito durante a amamentação</li>
<li>A maioria é segura para mães que amamentam</li>
</ul>

<h2>Conclusão</h2>
<p>O exame médico de imigração durante a gravidez é seguro e pode ser uma ótima oportunidade para garantir proteção adicional para você e seu bebê através de vacinas como Tdap e influenza. Na Atlas Healthcare, entendemos as necessidades especiais das gestantes e adaptamos nosso atendimento para garantir conforto e segurança.</p>
      `,
    },
    6: {
      content: `
<h2>Introdução</h2>
<p>Na Atlas Healthcare, entendemos que o processo de imigração pode gerar urgência e dúvidas. Por isso, oferecemos flexibilidade no atendimento, aceitando tanto agendamentos quanto walk-ins (atendimento sem agendamento). Neste artigo, vamos explicar como funciona cada opção e ajudá-lo a escolher a melhor alternativa para sua necessidade.</p>

<h2>Opções de Atendimento</h2>

<h3>1. Agendamento Online (Recomendado)</h3>
<p>Nosso sistema de agendamento online é a forma mais conveniente de marcar seu exame:</p>

<h4>Benefícios do Agendamento Online:</h4>
<ul>
<li>✅ Escolha o melhor horário para você</li>
<li>✅ Garantia de atendimento no dia e hora escolhidos</li>
<li>✅ Menor tempo de espera</li>
<li>✅ Preparação antecipada da equipe</li>
<li>✅ Lembrete automático do agendamento</li>
<li>✅ Possibilidade de preparar documentos com calma</li>
</ul>

<h4>Como Agendar Online:</h4>
<ol>
<li>Acesse nosso sistema de agendamento</li>
<li>Escolha o serviço "Exame de Imigração"</li>
<li>Selecione data e horário disponíveis</li>
<li>Preencha seus dados</li>
<li>Receba confirmação por e-mail ou SMS</li>
</ol>

<h4>Horários Disponíveis para Agendamento:</h4>
<ul>
<li>Segunda-feira: 9:30 - 16:00</li>
<li>Terça-feira: 9:30 - 16:00</li>
<li>Quinta-feira: 9:30 - 16:00</li>
<li>Sexta-feira: 9:30 - 13:00</li>
</ul>

<h3>2. Walk-ins (Sem Agendamento)</h3>
<p>Para quem precisa de atendimento imediato, aceitamos walk-ins:</p>

<h4>Benefícios dos Walk-ins:</h4>
<ul>
<li>✅ Atendimento imediato quando necessário</li>
<li>✅ Sem necessidade de esperar por data disponível</li>
<li>✅ Flexibilidade total de horário</li>
<li>✅ Ideal para urgências</li>
</ul>

<h4>Melhores Dias para Walk-ins:</h4>
<p>Baseado em nossa experiência, os melhores dias são:</p>
<ul>
<li><strong>Segundas-feiras:</strong> Menor movimento no início da semana</li>
<li><strong>Quintas-feiras:</strong> Bom dia com espera reduzida</li>
</ul>
<p>Horários recomendados: Logo no início do expediente (9:30) ou após o almoço.</p>

<h4>O que Esperar como Walk-in:</h4>
<ul>
<li>⏱️ Tempo de espera variável: Depende do número de pacientes no dia</li>
<li>📋 Atendimento por ordem de chegada: Pacientes agendados têm prioridade</li>
<li>🕐 Possível espera: Prepare-se para aguardar se estivermos cheios</li>
</ul>

<h2>Duração do Atendimento</h2>

<h3>Exame Completo:</h3>
<ul>
<li>30-45 minutos na maioria dos casos</li>
<li>Pode variar conforme complexidade individual</li>
<li>Inclui: Exame físico, coleta de sangue, revisão de vacinas</li>
</ul>

<h3>Fatores que Podem Aumentar o Tempo:</h3>
<ul>
<li>Necessidade de vacinas adicionais</li>
<li>Histórico médico complexo</li>
<li>Documentação incompleta</li>
<li>Necessidade de exames adicionais</li>
</ul>

<h2>Preparação para o Atendimento</h2>
<p>Seja agendado ou walk-in, a preparação é a mesma:</p>

<h3>Documentos Necessários:</h3>
<ul>
<li>Passaporte ou identidade válida</li>
<li>Cartão de vacinação (se disponível)</li>
<li>Lista de medicamentos</li>
<li>EAD (se aplicável)</li>
<li>Cartão de seguro saúde</li>
...
<h3>Dicas para Walk-ins:</h3>
<ul>
<li>Chegue cedo: Quanto antes, menor a espera</li>
<li>Venha preparado: Com todos os documentos</li>
<li>Tenha flexibilidade de tempo: Pode haver espera</li>
<li>Evite horários de pico: Meio da manhã e final da tarde</li>
</ul>

<h2>Política de Atrasos</h2>

<h3>Para Pacientes Agendados:</h3>
<ul>
<li>Chegue 15 minutos antes do horário</li>
<li>Atraso de até 10 minutos: Atendimento normal</li>
<li>Atraso de 10-15 minutos: Pode haver espera adicional</li>
<li>Atraso superior a 15 minutos: Pode ser necessário reagendar</li>
</ul>

<h3>Para Walk-ins:</h3>
<ul>
<li>Horário de chegada determina a ordem de atendimento</li>
<li>Após 15:30 (ou 12:30 às sextas), walk-ins podem não ser aceitos</li>
</ul>

<h2>Cancelamentos e Reagendamento</h2>

<h3>Se Precisar Cancelar:</h3>
<ul>
<li>Com antecedência: Cancele com pelo menos 24 horas de aviso</li>
<li>Online: Pelo sistema de agendamento</li>
<li>Por telefone: Entre em contato diretamente</li>
<li>Sem penalidade: Para cancelamentos com aviso prévio</li>
</ul>
...
<li>Pode ser feito online ou por telefone</li>
</ul>

<h2>Nossa Recomendação</h2>

<h3>✅ Agende Online Quando:</h3>
<ul>
<li>Você pode planejar com antecedência</li>
<li>Quer garantir atendimento em horário específico</li>
<li>Prefere evitar esperas</li>
<li>Tem flexibilidade de datas</li>
</ul>

<h3>✅ Venha como Walk-in Quando:</h3>
<ul>
<li>Você tem urgência real</li>
<li>Não consegue encontrar horário disponível online</li>
<li>Precisa de atendimento imediato</li>
<li>Está na região e quer aproveitar</li>
</ul>

<h2>Conclusão</h2>
<p>Na Atlas Healthcare, nossa prioridade é oferecer atendimento de qualidade da forma mais conveniente para você. Seja através de agendamento online ou como walk-in, nossa equipe está pronta para atendê-lo com excelência.</p>
<p><strong>Lembre-se:</strong> enquanto aceitamos walk-ins, o agendamento online garante um atendimento mais rápido e sem espera. Escolha a opção que melhor se adapta à sua necessidade.</p>
      `,
    },
    7: {
      content: `
<h2>Introdução</h2>
<p>Ao iniciar o processo de exame médico de imigração, muitas pessoas não entendem completamente a importância de escolher um Civil Surgeon autorizado pelo USCIS. Neste artigo, vamos explorar o papel fundamental deste profissional, por que a autorização é obrigatória e como fazer a escolha certa.</p>

<h2>O que é um Civil Surgeon?</h2>
<p>Um Civil Surgeon é um médico licenciado que recebeu autorização especial do USCIS (U.S. Citizenship and Immigration Services) para realizar exames médicos de imigração. Este não é apenas um título - é uma designação federal que exige:</p>

<h3>Requisitos para ser Civil Surgeon:</h3>
<ul>
<li>✅ Licença médica válida no estado</li>
<li>✅ Formação médica completa (MD ou DO)</li>
<li>✅ Treinamento específico sobre requisitos de imigração</li>
<li>✅ Aprovação do USCIS após processo rigoroso</li>
<li>✅ Manutenção de credenciais atualizadas</li>
<li>✅ Conhecimento das leis e regulamentações de imigração</li>
</ul>

<h2>Por que Apenas Civil Surgeons Autorizados Podem Realizar o Exame?</h2>

<h3>1. Responsabilidade Legal</h3>
<p>O Civil Surgeon assume responsabilidade legal sobre:</p>
<ul>
<li>Veracidade das informações no Formulário I-693</li>
<li>Conformidade com requisitos federais de saúde pública</li>
<li>Documentação adequada para o USCIS</li>
<li>Avaliação correta de condições de saúde</li>
</ul>

<h3>2. Padrões Federais</h3>
<p>O USCIS estabelece padrões rigorosos:</p>
<ul>
<li>Procedimentos padronizados em todo o país</li>
<li>Exames laboratoriais específicos obrigatórios</li>
<li>Critérios de vacinação uniformes</li>
<li>Documentação regulamentada</li>
</ul>

<h3>3. Proteção da Saúde Pública</h3>
<p>O Civil Surgeon atua como:</p>
<ul>
<li>Guardião da saúde pública americana</li>
<li>Detector de doenças que podem representar risco</li>
<li>Garantidor de conformidade com leis de saúde</li>
</ul>

<h2>O que um Civil Surgeon Faz?</h2>

<h3>1. Exame Físico Completo</h3>
<ul>
<li>Avaliação sistemática de todos os sistemas corporais</li>
<li>Detecção de doenças contagiosas ou preocupantes</li>
<li>Documentação detalhada dos achados</li>
<li>Avaliação de condições que possam afetar a admissibilidade</li>
</ul>

<h3>2. Revisão de Histórico Médico</h3>
<ul>
<li>Análise completa de doenças anteriores</li>
<li>Avaliação de tratamentos realizados</li>
<li>Verificação de condições crônicas</li>
<li>Documentação de medicações</li>
</ul>

<h3>3. Coordenação de Exames Laboratoriais</h3>
<ul>
<li>Prescrição de testes obrigatórios</li>
<li>Interpretação de resultados</li>
<li>Determinação de necessidade de tratamento adicional</li>
<li>Documentação de conformidade</li>
</ul>

<h3>4. Avaliação de Vacinas</h3>
<ul>
<li>Revisão do cartão de vacinação</li>
<li>Determinação de necessidades</li>
<li>Administração de vacinas quando apropriado</li>
<li>Documentação de imunidade</li>
</ul>

<h3>5. Preenchimento do Formulário I-693</h3>
<ul>
<li>Documentação completa e precisa</li>
<li>Lacração oficial do formulário</li>
<li>Garantia de aceitação pelo USCIS</li>
<li>Responsabilidade legal sobre o conteúdo</li>
</ul>

<h2>Consequências de Usar um Profissional Não Autorizado</h2>

<h3>❌ Riscos Graves:</h3>

<h4>Formulário Rejeitado</h4>
<ul>
<li>O USCIS não aceita exames de profissionais não autorizados</li>
<li>Pode resultar em atraso ou negação do processo</li>
</ul>

<h4>Perda de Tempo e Dinheiro</h4>
<ul>
<li>Necessidade de refazer todo o processo</li>
<li>Custos adicionais com novo exame</li>
<li>Atraso no processo de imigração</li>
</ul>

<h4>Complicações Legais</h4>
<ul>
<li>Possíveis questionamentos sobre intenção</li>
<li>Documentação inadequada pode gerar suspeitas</li>
<li>Pode afetar negativamente seu caso</li>
</ul>

<h4>Riscos à Saúde</h4>
<ul>
<li>Exames inadequados podem não detectar problemas</li>
<li>Falta de acompanhamento adequado</li>
<li>Documentação incompleta de condições</li>
</ul>

<h2>Como Verificar se um Profissional é Civil Surgeon Autorizado</h2>

<h3>1. Pergunte Diretamente</h3>
<ul>
<li>Peça para ver a designação do USCIS</li>
<li>Verifique se o profissional tem experiência com imigração</li>
<li>Confirme se está atualizado com as regulamentações</li>
</ul>

<h3>2. Verifique no Site do USCIS</h3>
<p>O USCIS mantém uma lista de Civil Surgeons designados, embora nem sempre seja completa ou atualizada.</p>

<h3>3. Sinais de Alerta</h3>
<p>Desconfie se:</p>
<ul>
<li>❌ O profissional não pode mostrar designação</li>
<li>❌ O preço é muito abaixo do mercado</li>
<li>❌ Não conhece os requisitos específicos</li>
<li>❌ Não sabe preencher o Formulário I-693 corretamente</li>
<li>❌ Promete resultados sem exames adequados</li>
</ul>

<h2>O Dr. Wingo: Experiência e Dedicação</h2>

<h3>Credenciais:</h3>
<ul>
<li>✅ Designação ativa do USCIS</li>
<li>✅ Mais de 10.000 exames realizados</li>
<li>✅ Taxa de aceitação de 100% pelo USCIS</li>
<li>✅ Experiência com casos complexos</li>
<li>✅ Atualização constante em regulamentações</li>
</ul>

<h3>Diferenciais:</h3>
<ul>
<li><strong>Atendimento multilíngue:</strong> Português, Espanhol e Inglês</li>
<li><strong>Processo simplificado:</strong> Maioria dos exames em uma visita</li>
<li><strong>Equipe especializada:</strong> Treinada especificamente para imigração</li>
<li><strong>Compromisso com qualidade:</strong> Cada paciente recebe atenção individual</li>
</ul>

<h2>Perguntas para Fazer ao Escolher um Civil Surgeon</h2>

<h3>Antes de Agendar, Pergunte:</h3>
<ul>
<li>"Você é Civil Surgeon designado pelo USCIS?"</li>
<li>"Quantos exames de imigração você realiza por mês?"</li>
<li>"O que está incluído no valor do exame?"</li>
<li>"Quanto tempo leva para receber o formulário lacrado?"</li>
<li>"Você fala [seu idioma]?"</li>
<li>"Qual é sua taxa de aceitação pelo USCIS?"</li>
</ul>

<h2>Por que Escolher a Atlas Healthcare?</h2>

<h3>1. Experiência Comprovada</h3>
<ul>
<li>Mais de 10.000 exames realizados com sucesso</li>
<li>100% de aceitação pelo USCIS</li>
<li>Anos de experiência específica em imigração</li>
</ul>

<h3>2. Conveniência</h3>
<ul>
<li>Tudo em um só lugar: Exame, laboratório e vacinas</li>
<li>Uma única visita na maioria dos casos</li>
<li>Resultados rápidos e formulário pronto em poucos dias</li>
</ul>

<h3>3. Atendimento Humanizado</h3>
<ul>
<li>Equipe multilíngue: Português, Espanhol e Inglês</li>
<li>Ambiente acolhedor: Especialmente para imigrantes</li>
<li>Suporte contínuo: Antes, durante e após o exame</li>
</ul>

<h3>4. Transparência Total</h3>
<ul>
<li>Preços claros: Sem taxas ocultas</li>
<li>Processo explicado: Você sabe exatamente o que esperar</li>
<li>Documentação completa: Tudo conforme exigido pelo USCIS</li>
</ul>

<h2>Conclusão</h2>
<p>A escolha do Civil Surgeon é uma das decisões mais importantes no processo de imigração. Um profissional autorizado e experiente garante:</p>
<ul>
<li>✅ Aceitação garantida pelo USCIS</li>
<li>✅ Processo sem complicações</li>
<li>✅ Segurança e qualidade</li>
<li>✅ Tranquilidade em uma etapa crucial</li>
</ul>
<p><strong>Não arrisque seu sonho americano com profissionais não autorizados. Escolha experiência, qualidade e garantia de sucesso.</strong></p>
      `,
    },
  },
  es: {
